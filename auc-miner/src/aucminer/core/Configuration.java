...
public class Configuration {
	...
	public Configuration(String workingDirectory, String oldVersionProject, String newVersionProject) {
		this.workingDirectory = workingDirectory;
		this.oldVersionProject = oldVersionProject;
		this.newVersionProject = newVersionProject;
	}
