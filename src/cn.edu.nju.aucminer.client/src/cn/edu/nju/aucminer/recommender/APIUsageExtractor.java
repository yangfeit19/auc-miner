...
public class APIUsageExtractor {
	...
	public APIUsageExtractor(String clientProjectName, IAPIUsageFilter apiUsageFilter) {
	...
	class InvocationExtractor extends ASTVisitor {
		...
		private IAPIUsageFilter apiUsageFiletr;
		
		private String fileFullPath;
		private List<InvocationInfo> apiUsageList;
		
		public InvocationExtractor(String projectName, ICompilationUnit compilationUnit, CompilationUnit astNode, IAPIUsageFilter apiUsageFilter) {
		...
		private void addInvocationInfo(ASTNode node, String name, IMethodBinding methodBinding) {
			...
			if (fullQualifiedName != null && !fullQualifiedName.isEmpty()) {
				...
				InvocationInfo invocationInfo = new InvocationInfo(
						new MethodInfo(fullQualifiedName), 
